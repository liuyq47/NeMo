...
from transformers import BERT_PRETRAINED_CONFIG_ARCHIVE_MAP, BERT_PRETRAINED_MODEL_ARCHIVE_LIST, BertConfig, BertModel, BertForPreTraining
...
class BertPretrain(TrainableNM):
    """
    ...
    def output_ports(self):
        ...
        """
        return {"mlm_logits": NeuralType(('B', 'T', 'C'), LogitsType()),
                "nsp_logits": NeuralType(('B', 'D'), LogitsType()),
                }
